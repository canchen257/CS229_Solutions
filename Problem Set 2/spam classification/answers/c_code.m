% % Input the different file and get the corrresonding error rate as below
% trainSize = [50,100,200,400,800,1400];
% testError = [0.0187, 0.0175,0.0125, 0.0125,0.0138, 0.0125];
% figure();
